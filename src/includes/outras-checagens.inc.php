...
$agencias = [
  ...
  'boatos'  => ['title'=> 'Boatos', 'link'=> 'https://www.boatos.org', 'img'=> 'boatos.png'],
  'afp'     => ['title'=> 'AFP', 'link'=> 'https://www.afp.com/pt', 'img'=> 'afp.png'],
  'comprova'=> ['title'=> 'Comprova', 'link'=> 'https://projetocomprova.com.br', 'img'=> 'comprova.png'],
...
$outrasChecagens = [
  [
    ...
    'data'        => '25/08/2020',
    "label"       => [$agencias['lupa'], $agencias['efarsas'], $agencias['estadao'], $agencias['boatos'], $agencias['afp'], $agencias['comprova'], $agencias['uol'], $agencias['aos'], $agencias['fatofake'], $agencias['tse']]
  ],
  [
    ...
    'img'         => null,
    'data'        => '02/08/2020',
    "label"       => [$agencias['lupa'], $agencias['estadao'], $agencias['efarsas'], $agencias['boatos'], $agencias['afp'], $agencias['comprova'], $agencias['uol'], $agencias['aos'], $agencias['fatofake'], $agencias['tse']]
  ],
  [
      ...
      <?php
        ...
        <div class="check-label">
          <a target="_blank" href="<?= $label['link'];?>">
            <img src="imagens/logos/cards/<?= $label['img']; ?>" alt="<?= $label['title']; ?>" title="<?= $label['title'];?>" />
          </a>
        </div>
